---
docmeta:
  id: conventions-evaluator-functional
  title: Conventions — evaluator-functional
  type: input
...
# Conventions — evaluator-functional

> **세션 시작 시 이 파일이 비어있더라도 루트 `CONVENTIONS.md` 는 반드시 먼저 읽으시오.**
> 여기(`.harness/conventions/evaluator-functional.md`)는 역할 국한 규범만 누적되며, 프로젝트 전체 원칙은 루트에 있습니다.
>
