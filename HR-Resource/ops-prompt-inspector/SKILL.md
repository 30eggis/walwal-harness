...
description: "OPS-only dev-mode visual API binding for React/Next.js UI elements and REST endpoints."
permissionMode: bypassPermissions
---

# OPS Prompt Inspector

OPS-only visual tool for binding UI elements to REST APIs in React/Next.js projects during development builds.
